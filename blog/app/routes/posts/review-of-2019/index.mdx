...
- <BlockLink href="https://blog.p1ass.com/posts/aktsk-intern/">
    ドメインロジックと永続化処理を分離する設計改善を行って得られた知見 -
    ぷらすのブログ
  </BlockLink>
- <BlockLink href="https://blog.p1ass.com/posts/abema-intern/">
    CyberAgentのAbemaTVでインターンしてきた話 - ぷらすのブログ
  </BlockLink>
- <BlockLink href="https://blog.p1ass.com/posts/dena-intern/">
    DeNAのエンジニアサマーインターンで優勝してきた - ぷらすのブログ
  </BlockLink>
- <BlockLink href="https://blog.p1ass.com/posts/line-intern/">
    LINEの就業型インターンに参加してきた - ぷらすのブログ
  </BlockLink>
- <BlockLink href="https://blog.p1ass.com/posts/cyberagent-architecture-challenge/">

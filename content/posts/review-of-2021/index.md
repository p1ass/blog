...
仕事で書くコードの目新しさが減ってきたら、そのうち趣味でコードを書く時間が増えるかもしれません。

## 仕事

次のトピックは仕事です。
4 月からアルバイト → 正社員にジョブチェンジしました。
...
結論から言うと、ほぼ目標のアセットアロケーションで着地しました。
...
{{<ex-link url="https://blog.p1ass.com/posts/moving-when-new-graduates/">}}
...
{{<ex-link url="https://anime.dmkt-sp.jp/animestore/ci_pc?workId=10195">}}
...
{{<ex-link url="https://www.nintendo.co.jp/ring/">}}

ゼルダの伝説スカイウォードソード HD は私が始めてプレイしたゼルダのリメイクということで、とても感慨深いゲームでした。
Wii リモコンを降って剣や盾を操作するプレイスタイルは Joy-Con になっても踏襲されており、自分の体を使う遊び方の面白さを再認識しました。

{{<ex-link url="https://www.nintendo.co.jp/switch/az89a/index.html">}}

ポケットモンスター ブリリアントダイヤモンドもゼルダと同様に始めてプレイしたポケモンだったのでエモさ MAX でした。
{{<twitter url="https://twitter.com/p1ass/status/1461355690870525968">}}

{{<ex-link url="https://www.pokemon.co.jp/ex/bdsp/ja/">}}
...
2021 年は 2020 年に比べてかなり充実した 1 年になりました。

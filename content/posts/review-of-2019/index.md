...
自分でも「多すぎやろ！」とツッコミたくなるのですが、色んな会社での開発の現場をこんな短期間で見て回れるのはこの先ないと思うので、参加して良かったです。
...
きっかけは、2019年の代表であった @shiba6v さんからの熱いプッシュでした。最初はあまり乗り気ではなかったのですが、気づいたあら承諾して運営になっていました。

運営になってから様々なイベントの企画や、開発に携わることができました。学校では表立って活動するタイプではなかったので、運営のような仕事をした経験はなかったのですが、周りに助けられながら様々なことにチャレンジできました。

...
date: 2021-12-28T21:45:00+09:00
draft: false
description: 普段利用しているブックマークサービスである Pocket の API を使って、今年ブックマークした記事の一覧をまとめてみました。合計記事数は 285 で大量にあるので、目次をみつつ漁ってみてください。
categories:
  - 雑記
tags:
  - ブックマーク
...
合計記事数は 285 で大量にあるので、目次をみつつ漁ってみてください。
1 記事くらいは役に立つものがあると思います、多分。

なお、記事の一覧は下記のスクリプトを使って生成しました。
急いで作ったので拡張性は無なので、使いたい方は適当に手直しして使ってください。

...
この10年間の間に何度かこの管理方法を説明してきたけど、メリットが理解されなかったり、行動まで移す人は少なかった。
...
Gmailの場合はメールをアーカイブしてもすべてのメールを検索できるので、後で見返すことができる。
...
Gmailだと大量のメールのアーカイブはバックグラウンドで実行されて数十分かかることもあるが、すこし待てば受信トレイはすっからかんになって、アーカイブ実施後に届いたメールだけが残る。
...
僕はこの思想に関心し、その後もMailboxのサービス終了まで使い続けた。サービス終了後はGmailの公式アプリを使いつつ同じ管理を続けている。
...
この記事では、僕が10年以上続けている **「受信トレイが空っぽであることが理想」** という思想のもと行っている、メールの管理方法を紹介した。

...
const detected: [string, string][] = [
  ...
  ['11 箇所で場当たりに使われていました。', '場当たり'],
  ['色の原料をここに置きます。', '原料'],
  ['コードを変えていなくても CI が赤くなります。', '色で表して'],
  ['比較が緑になりました。', '色で表して'],
  ['似た役割の部品を探します。', '部品'],
  ['UI 部品は 3 対 1 を満たします。', '部品'],
  ['生の値の検査を CI で回します。', '検査'],
  ['ビルドの最後に検査します。', '検査'],
]
...
const notDetected: string[] = [
  ...
  '動画の素材を差し替えます。', // 素材 は記事に 2 件あり筆者の語彙なので入れていない
  'AtCoder は緑です。', // 緑 + です なので 緑になる に当たらない
  '赤黒木の詳細は省く。', // 赤 は名詞なので 形容詞の 赤い に当たらない
  '暗黙的にアクセスできます。', // 暗黙 は名詞なので 黙る に当たらない
  '暗黙的に必要とされるスキルがあります。', // 同上
  '出力の品質が落ちました。', // 助詞が「が」なので に落ちる に当たらない
  '検査官が来ました。', // 検査官 は 1 語に割れるので 検査 に当たらない
  '検索の結果を貼ります。', // 検索 は別の名詞
  '差分が出ないことを確かめます。', // 出る は記事で 42 件使う筆者の語彙なので入れていない
]

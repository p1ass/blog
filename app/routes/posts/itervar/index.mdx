...
<ExLinkCard url="https://play.golang.org/p/3j5V3yHWx4G"/>

このコードを実行すると、`out` の中身は`{3, 3, 3}` と、同じ値になってしまいます。`i`のポインタ値がどのイテレーションでも同じなことが原因です。詳しくは以前ブログに書きました。

<ExLinkCard url="https://blog.p1ass.com/posts/pointer-of-for-range-loop-of-go/"/>
...
<ExLinkCard url="https://github.com/golang/go/issues/16520"/>

<ExLinkCard url="https://github.com/golang/go/issues/20725"/>

## 作ったもの

この間違いを検出する静的解析ツールを作りました。名前は itervar です。

<ExLinkCard url="https://github.com/p1ass/itervar"/>
...
<ExLinkCard url="https://github.com/gostaticanalysis/skeleton"/>

...
設定しなくても先程インストールした Corretto が選択できるようになっているはず。
...
[Effective Java 第 3 版](https://www.amazon.co.jp/dp/4621303252?&linkCode=ll1&tag=p1ass02-22&linkId=2c2e6e7a09c64829a2fd6c06ed45e3ff&language=ja_JP&ref_=as_li_ss_tl)

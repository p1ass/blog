...
openai-agents 0.22.3 で確認しており、実行には環境変数 `OPENAI_API_KEY` が必要です。コードの全体は [GitHub](https://github.com/p1ass/blog/blob/main/app/routes/posts/agent-foundations/sdk-agent/openai_agent.py) にあります。
...
claude-agent-sdk 0.2.158 で確認しており、実行には環境変数 `ANTHROPIC_API_KEY` が必要です。コードの全体は [GitHub](https://github.com/p1ass/blog/blob/main/app/routes/posts/agent-foundations/sdk-agent/claude_agent.py) にあります。
...
OpenAI Agents SDK と Claude Agent SDK はどちらもこの構造を基本としていることを確認しました。

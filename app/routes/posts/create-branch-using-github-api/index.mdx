...
<ExLinkCard url="https://stackoverflow.com/questions/9506181/github-api-create-branch/9513594"/>

GitHub API を用いてブランチを作成するには、git の ref(参照)を操作する API を使用します。

<BlockLink href="https://docs.github.com/ja/rest/reference/git#refs">
...
引用: [Git の内側 - Git の参照](https://git-scm.com/book/ja/v2/Git%E3%81%AE%E5%86%85%E5%81%B4-Git%E3%81%AE%E5%8F%82%E7%85%A7)

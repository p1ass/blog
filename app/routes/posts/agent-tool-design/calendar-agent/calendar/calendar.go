...
func New() *Calendar {
	names := []struct{ name, dept string }{
		{"伊波 太郎", "開発部"}, {"伊波 修", "営業部"}, {"一ノ瀬 奈々", "開発部"},
		{"鈴木 一郎", "人事部"}, {"橘 美咲", "開発部"}, {"伏見 大輔", "営業部"},
		{"紫宮 さくら", "経理部"}, {"渋谷 翔", "開発部"}, {"如月 優子", "デザイン部"},
		{"小林 直樹", "営業部"}, {"笹木 恵", "開発部"}, {"吉田 拓也", "人事部"},
		{"藍沢 彩", "経理部"}, {"白雪 亮", "開発部"}, {"中村 真央", "デザイン部"},
		{"早瀬 蓮", "開発部"}, {"井上 陽菜", "営業部"}, {"緋月 麻衣", "開発部"},
		{"樋口 結衣", "人事部"}, {"清水 颯", "開発部"},
	}
	c := &Calendar{}
	for i, n := range names {

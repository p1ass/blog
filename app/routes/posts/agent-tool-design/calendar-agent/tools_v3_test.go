...
func TestFindFreeSlots(t *testing.T) {
	...
	const want = "2026-09-28 (月) に 田中 太郎、佐藤 健 が全員空いている 30 分の枠: 16:00-16:30"
	tests := []struct {
		name  string
		input string
	}{
		{
			...
			input: `{"participants":["田中 太郎","佐藤"],"date":"2026-09-28","duration_minutes":30,"earliest":"12:00","latest":"18:00"}`,
		},
		{
			name:  "earliest が 30 分単位でなくても空き枠を見落とさない",
			input: `{"participants":["田中 太郎","佐藤"],"date":"2026-09-28","duration_minutes":30,"earliest":"12:15","latest":"18:00"}`,
		},
		{
		...
		},
		{
			...
			input: `{"participants":["田中 太郎","田中太郎","佐藤"],"date":"2026-09-28","duration_minutes":30,"earliest":"12:00","latest":"18:00"}`,
		},
	}
